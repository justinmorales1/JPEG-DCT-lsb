...
#include "..\include\jpenquan.h"
#include "..\include\jpegenco.h"
#include "..\include\jpgexcep.h"
...
//    FDCT algorithm.
//
void JpegEncoderQuantizationTable::BuildScaledTables () // jao - this is where tables get built, my code below gets 
														// correct values from data_values - it holds scaled data that
														// I want
{
...
UBYTE2 JpegEncoderQuantizationTable::GetDataValue (int index)
{
